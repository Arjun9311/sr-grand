...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-glow hover:bg-primary/92 hover:shadow-copper",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/82 border border-border/70",
        outline:
          "border border-primary/35 bg-background/25 text-foreground hover:border-primary/70 hover:bg-primary/10",
        ghost: "text-foreground hover:bg-white/8",
        link: "h-auto rounded-none px-0 text-primary underline-offset-4 hover:underline",
        copper:
          "bg-copper text-cream shadow-copper hover:bg-copper/88 border border-primary/20"
      },
      size: {
