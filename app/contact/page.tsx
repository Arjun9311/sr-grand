        ...
        <div className="container grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="space-y-4">
            <div className="rounded-2xl border border-border/70 bg-card p-6">
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-foreground">Official address</h2>
            ...
            <div className="rounded-2xl border border-border/70 bg-card p-6">
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-foreground">Timings</h2>
